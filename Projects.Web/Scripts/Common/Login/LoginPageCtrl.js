(function (app) {
    ...
    LoginPageCtrl.$inject = ['$scope', 'apiService', 'membershipService', 'notificationService', '$rootScope', '$location', '$cookieStore','$window'];

    function LoginPageCtrl($scope, apiService, membershipService, notificationService, $rootScope, $location, $cookieStore, $window) {
        ...
        function GetStockList() {
            apiService.get('api/addstock/GetRawStockList/1', null, GetRawStockListComplete, GetRawStockListFailed);
        }
        ...
        function loginCompleted(result) {
           // $templateCache.removeAll();
            if (result.data.success) {
                ...
                $cookieStore.put('ck_tenant', $rootScope.tenant);
        ...
        function GetProductListComplete(response) {
            ...
            $cookieStore.put('ck_productList', $rootScope.productsList);
